            ...
            <div className={styles.content}>
                ...
                <section className={styles.section}>
                    ...
                    <ul>
                        ...
                        <li><strong>Payment information</strong> - Processed securely through Paypal</li>
                    </ul>
                </section>
                ...
                <section className={styles.section}>
                    ...
                    <ul>
                        <li><strong>Image Generation</strong> - To create AI-generated product images based on your product details</li>
                ...
                <section className={styles.section}>
                    ...
                    <ul>
                        ...
                        <li><strong>Hetzner</strong> - Website hosting and performance</li>
                        <li><strong>BetterAuth</strong> - Authentication services</li>
                    </ul>
                </section>
